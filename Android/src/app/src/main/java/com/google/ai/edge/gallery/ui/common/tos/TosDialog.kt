    ...
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp)) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          // Short content.
          MarkdownText(
            "To use Kontext AI Personalization Agent, you accept " +
              "(1) the [Google Terms of Service](https://policies.google.com/terms), and (2) " +
              "these Kontext AI Personalization Agent App Additional Terms of Service. Please read these " +
          ...
          if (viewFullTerms) {
            MarkdownText(
              "In addition, your use of any Gemma models in the Kontext AI Personalization Agent app is " +
                ...
                "\n" +
                "Your use of any other AI models in Kontext AI Personalization Agent is subject to " +
                ...
                "\n" +
                "Kontext AI Personalization Agent may collect anonymous usage data about your use of the " +
